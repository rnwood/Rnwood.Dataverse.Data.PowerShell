# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:49.7693679+00:00.
...
Describe 'Invoke-DataverseCancelContract' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set' {
        ...
        $result = Invoke-DataverseCancelContract -Connection $script:conn -ContractId $testContractId
