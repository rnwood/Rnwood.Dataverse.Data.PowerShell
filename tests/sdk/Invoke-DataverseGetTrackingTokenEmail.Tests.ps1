# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:47:39.0758307+00:00.
#     Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.
# </auto-generated>

Describe 'Invoke-DataverseGetTrackingTokenEmail' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            Invoke-DataverseGetTrackingTokenEmail -Connection $script:conn -Subject $testSubject
        } catch {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException|not yet supported|OpenSourceUnsupportedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support GetTrackingTokenEmailRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.GetTrackingTokenEmailResponse
                $mockResponse
            } else {
                throw
            }
        ...
        $result.GetType().FullName | Should -Match 'OrganizationResponse|GetTrackingTokenEmail'
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataverseGetTrackingTokenEmail -Connection $script:conn -Subject $testSubject -WhatIf
