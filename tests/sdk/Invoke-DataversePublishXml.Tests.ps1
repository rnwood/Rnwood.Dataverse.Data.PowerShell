# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:48:10.9088538+00:00.
#     Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.
# </auto-generated>

Describe 'Invoke-DataversePublishXml' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $testParameterXml = "TestParameterXmlValue"

        # Execute the cmdlet - wrap in try-catch for FakeXrmEasy unsupported requests
        $result = try {
            Invoke-DataversePublishXml -Connection $script:conn -ParameterXml $testParameterXml
        } catch {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException|not yet supported|OpenSourceUnsupportedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support PublishXmlRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.PublishXmlResponse
                $mockResponse
            } else {
                throw
            }
        ...
        $result.GetType().FullName | Should -Match 'OrganizationResponse|PublishXml'
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataversePublishXml -Connection $script:conn -ParameterXml $testParameterXml -WhatIf
