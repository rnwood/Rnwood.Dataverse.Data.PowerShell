# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T06:56:13.3768837+00:00.
#     Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.
# </auto-generated>


Describe 'Invoke-DataverseRetrieveUserPrivileges' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            Invoke-DataverseRetrieveUserPrivileges -Connection $script:conn -UserId $testUserId
        } catch {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException|not yet supported|OpenSourceUnsupportedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support RetrieveUserPrivilegesRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.RetrieveUserPrivilegesResponse
                $mockResponse
            } else {
                throw
            }
        ...
        $result.GetType().FullName | Should -Match 'OrganizationResponse|RetrieveUserPrivileges'
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataverseRetrieveUserPrivileges -Connection $script:conn -UserId $testUserId -WhatIf
