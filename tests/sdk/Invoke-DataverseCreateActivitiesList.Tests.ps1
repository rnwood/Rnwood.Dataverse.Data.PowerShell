# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:08:37.1314862+00:00.
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support CreateActivitiesListRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.CreateActivitiesListResponse
                $mockResponse
            } else {
                throw
            }
