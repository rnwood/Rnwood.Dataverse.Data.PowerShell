# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:25:57.8155722+00:00.
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException|not yet supported|OpenSourceUnsupportedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support ImportSolutionAsyncRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.ImportSolutionAsyncResponse
                $mockResponse
            } else {
                throw
            }
