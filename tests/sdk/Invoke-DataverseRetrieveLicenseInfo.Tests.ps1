# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:48:00.8583737+00:00.
#     Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.
# </auto-generated>

Describe 'Invoke-DataverseRetrieveLicenseInfo' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            Invoke-DataverseRetrieveLicenseInfo -Connection $script:conn -AccessMode $testAccessMode
        } catch {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException|not yet supported|OpenSourceUnsupportedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support RetrieveLicenseInfoRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.RetrieveLicenseInfoResponse
                $mockResponse
            } else {
                throw
            }
        ...
        $result.GetType().FullName | Should -Match 'OrganizationResponse|RetrieveLicenseInfo'
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataverseRetrieveLicenseInfo -Connection $script:conn -AccessMode $testAccessMode -WhatIf
