# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:25:17.4562712+00:00.
#     Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.
# </auto-generated>

Describe 'Invoke-DataverseParseImport' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            Invoke-DataverseParseImport -Connection $script:conn -ImportId $testImportId
        } catch {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException|not yet supported|OpenSourceUnsupportedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support ParseImportRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.ParseImportResponse
                $mockResponse
            } else {
                throw
            }
        ...
        $result.GetType().FullName | Should -Match 'OrganizationResponse|ParseImport'
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataverseParseImport -Connection $script:conn -ImportId $testImportId -WhatIf
