# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T08:35:50.9834062+00:00.
...
Describe 'Invoke-DataverseUpsertMultiple' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $testEntity['firstname'] = 'UpsertFirst'
        $testEntity['lastname'] = 'UpsertLast'
