# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:31:19.3714087+00:00.
...
Describe 'Invoke-DataverseInstantiateFilters' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            Invoke-DataverseInstantiateFilters -Connection $script:conn -UserId $testUserId
        } catch {
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataverseInstantiateFilters -Connection $script:conn -UserId $testUserId -WhatIf
