# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:31:49.5677748+00:00.
#     Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.
# </auto-generated>


Describe 'Invoke-DataverseDownloadBlock' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            Invoke-DataverseDownloadBlock -Connection $script:conn -FileContinuationToken $testFileContinuationToken
        } catch {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support DownloadBlockRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.DownloadBlockResponse
                $mockResponse
            } else {
                throw
            }
        ...
        $result.GetType().FullName | Should -Match 'OrganizationResponse|DownloadBlock'
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataverseDownloadBlock -Connection $script:conn -FileContinuationToken $testFileContinuationToken -WhatIf
