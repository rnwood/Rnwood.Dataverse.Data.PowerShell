# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:47:49.0030566+00:00.
#     Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.
# </auto-generated>

Describe 'Invoke-DataverseRetrieveUserQueues' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $testIncludePublic = $true

        # Execute the cmdlet - wrap in try-catch for FakeXrmEasy unsupported requests
        $result = try {
            Invoke-DataverseRetrieveUserQueues -Connection $script:conn -UserId $testUserId -IncludePublic $testIncludePublic
        } catch {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException|not yet supported|OpenSourceUnsupportedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support RetrieveUserQueuesRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.RetrieveUserQueuesResponse
                $mockResponse
            } else {
                throw
            }
        ...
        $result.GetType().FullName | Should -Match 'OrganizationResponse|RetrieveUserQueues'
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataverseRetrieveUserQueues -Connection $script:conn -UserId $testUserId -IncludePublic $testIncludePublic -WhatIf
