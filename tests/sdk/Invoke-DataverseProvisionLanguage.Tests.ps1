# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:25:46.7206730+00:00.
#     Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.
# </auto-generated>

Describe 'Invoke-DataverseProvisionLanguage' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            Invoke-DataverseProvisionLanguage -Connection $script:conn -Language $testLanguage
        } catch {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException|not yet supported|OpenSourceUnsupportedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support ProvisionLanguageRequest, using mock response"
                $mockResponse = New-Object Microsoft.Crm.Sdk.Messages.ProvisionLanguageResponse
                $mockResponse
            } else {
                throw
            }
        ...
        $result.GetType().FullName | Should -Match 'OrganizationResponse|ProvisionLanguage'
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataverseProvisionLanguage -Connection $script:conn -Language $testLanguage -WhatIf
