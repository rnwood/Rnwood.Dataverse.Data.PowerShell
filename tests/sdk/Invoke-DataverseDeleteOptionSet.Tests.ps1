# <auto-generated>
#     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:33:14.6072149+00:00.
...
Describe 'Invoke-DataverseDeleteOptionSet' -Tag 'SDK' {
    ...
    It 'Executes successfully with Default parameter set and validates input conversions' {
        ...
        $result = try {
            Invoke-DataverseDeleteOptionSet -Connection $script:conn -Name $testName
        } catch {
            ...
            if ($_.Exception.Message -match 'not been implemented|NotImplementedException') {
                ...
                Write-Verbose "FakeXrmEasy does not support DeleteOptionSetRequest, using mock response"
                $mockResponse = New-Object Microsoft.Xrm.Sdk.Messages.DeleteOptionSetResponse
                $mockResponse
            } else {
                throw
            }
    ...
    It 'Supports -WhatIf parameter' {
        ...
        $result = Invoke-DataverseDeleteOptionSet -Connection $script:conn -Name $testName -WhatIf
