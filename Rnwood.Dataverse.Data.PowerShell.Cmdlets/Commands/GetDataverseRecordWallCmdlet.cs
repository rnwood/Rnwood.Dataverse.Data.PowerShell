...
{
    [Cmdlet(VerbsCommon.Get, "DataverseRecordWall")]
    [OutputType(typeof(RetrieveRecordWallResponse))]
    ///<summary>Executes RetrieveRecordWallRequest SDK message.</summary>
    public class GetDataverseRecordWallCmdlet : OrganizationServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new RetrieveRecordWallRequest();
            if (Entity != null)
            {
            ...
            var response = (RetrieveRecordWallResponse)Connection.Execute(request);
