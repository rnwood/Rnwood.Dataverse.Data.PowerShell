...
{
    [Cmdlet(VerbsCommunications.Send, "DataversePromoteEmail", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(DeliverPromoteEmailResponse))]
    ///<summary>Executes DeliverPromoteEmailRequest SDK message.</summary>
    public class SendDataversePromoteEmailCmdlet : OrganizationServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (ShouldProcess("Executing DeliverPromoteEmailRequest", "DeliverPromoteEmailRequest"))
            {
                var response = (DeliverPromoteEmailResponse)Connection.Execute(request);
