// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:46.0057082+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataversePropagateByExpression", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataversePropagateByExpressionCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the query criteria to select accounts, contacts, or leads for which activities are created. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the user-identifiable name for the campaign. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the ownership options for propagation. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the owner for the activity. Required. Accepts PSObject with Id and TableName/EntityName/LogicalName properties, or a string containing the entity name for lookup by name.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the queue to which the created activities are added. Optional.")]
