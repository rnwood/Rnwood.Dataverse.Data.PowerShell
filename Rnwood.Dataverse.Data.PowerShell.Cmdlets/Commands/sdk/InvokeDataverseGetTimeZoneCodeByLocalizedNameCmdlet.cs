// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-06T19:49:43.3619581+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseGetTimeZoneCodeByLocalizedName", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseGetTimeZoneCodeByLocalizedNameCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the localized name to search for.")]
        public System.String LocalizedStandardName { get; set; }

        /// <summary>
        /// Gets or sets the locale ID. Required.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the locale ID. Required.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.GetTimeZoneCodeByLocalizedNameRequest();
                        request.LocalizedStandardName = LocalizedStandardName;
