// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T08:17:12.1226796+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseInsertStatusValue", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseInsertStatusValueCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Reserved for future use. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the logical name of the status column. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the logical name of the table that contains the status column. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the value for the new status option. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the label for the new status option. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets a description for the status option. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the state code for the new status option. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the solution that this status option should be added to. Optional.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Xrm.Sdk.Messages.InsertStatusValueRequest();
