// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:11.0249823+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseSetAutoNumberSeed", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseSetAutoNumberSeedCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the logical name of the table. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the logical name of the column. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the seed value to set. Required.")]
