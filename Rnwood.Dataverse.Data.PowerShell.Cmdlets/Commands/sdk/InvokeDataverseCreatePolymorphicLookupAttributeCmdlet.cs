// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:41.8630495+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    public class InvokeDataverseCreatePolymorphicLookupAttributeCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the lookup column definition that stores a reference to the related row.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the one-to-many relationship definitions for each table that the multi-table lookup column supports.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the name of the unmanaged solution to add the multi-table lookup column to.")]
