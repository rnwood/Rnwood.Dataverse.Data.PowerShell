// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:34:01.0668800+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseCopySystemForm", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseCopySystemFormCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = "Gets or sets the that the original system form should be copied to. Optional. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(Mandatory = true, HelpMessage = "Gets or sets the that the original system form should be copied to. Optional. The logical name of the table/entity type for the Target parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the that the original system form should be copied to. Optional. Properties to ignore when converting Target PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the that the original system form should be copied to. Optional. Hashtable specifying lookup columns for entity reference conversions in Target.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the ID value of the form to copy. Required.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.CopySystemFormRequest();
