// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-06T19:48:56.0826835+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataversePickFromQueue", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataversePickFromQueueCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the user to assign the queue item to. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets whether the queue item should be removed from the queue.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.PickFromQueueRequest();
                        request.QueueItemId = QueueItemId;
            request.WorkerId = WorkerId;
            request.RemoveQueueItem = RemoveQueueItem;
