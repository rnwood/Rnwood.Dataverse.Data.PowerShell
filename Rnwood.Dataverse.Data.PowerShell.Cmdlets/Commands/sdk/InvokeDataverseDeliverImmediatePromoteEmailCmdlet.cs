// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T06:55:22.6256139+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseDeliverImmediatePromoteEmail", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseDeliverImmediatePromoteEmailCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Body of the REST API request. Can be a string (JSON) or a PSObject which will be converted to JSON.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the AttachmentIds for the request.")]
        public System.String[] AttachmentIds { get; set; }

        /// <summary>
        /// Gets or sets the EWSUrl for the request.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the EWSUrl for the request.")]
        public System.String EWSUrl { get; set; }

        /// <summary>
        /// Gets or sets the AttachmentToken for the request.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the AttachmentToken for the request.")]
        public System.String AttachmentToken { get; set; }
        ...
        [Parameter(HelpMessage = "For internal use only. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type. The logical name of the table/entity type for the ExtraProperties parameter.")]
        ...
        [Parameter(HelpMessage = "For internal use only. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type. Properties to ignore when converting ExtraProperties PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "For internal use only. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type. Hashtable specifying lookup columns for entity reference conversions in ExtraProperties.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.DeliverImmediatePromoteEmailRequest();
