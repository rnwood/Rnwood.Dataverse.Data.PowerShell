// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T09:10:32.3333090+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseDeleteOptionValue", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseDeleteOptionValueCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the logical name of the table that contains the column. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the solution name associated with this option value. Optional.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Xrm.Sdk.Messages.DeleteOptionValueRequest();
