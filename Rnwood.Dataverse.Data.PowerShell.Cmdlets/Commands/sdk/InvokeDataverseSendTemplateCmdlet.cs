// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:25:26.3043423+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseSendTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseSendTemplateCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the type of entity that is represented by the list of recipients. Required.")]
        public System.String RecipientType { get; set; }

        /// <summary>
        /// Gets or sets the array that contains the list of recipients for the email. Required.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the array that contains the list of recipients for the email. Required.")]
        public System.Guid[] RecipientIds { get; set; }
        ...
        [Parameter(HelpMessage = "Gets or sets the delivery priority code for the email.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.SendTemplateRequest();
            ...
            request.DeliveryPriorityCode = DeliveryPriorityCode;
