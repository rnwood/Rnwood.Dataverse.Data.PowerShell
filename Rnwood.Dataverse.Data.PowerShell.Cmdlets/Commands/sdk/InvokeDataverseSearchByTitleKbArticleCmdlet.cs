// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T20:29:12.0035173+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseSearchByTitleKbArticle", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseSearchByTitleKbArticleCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the title in the articles. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the subject for the knowledge base article. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets a value that indicates whether to use inflectional stem matching when you search for knowledge base articles by a specific title. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the query criteria to find knowledge base articles with the specified title. Required.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.SearchByTitleKbArticleRequest();
