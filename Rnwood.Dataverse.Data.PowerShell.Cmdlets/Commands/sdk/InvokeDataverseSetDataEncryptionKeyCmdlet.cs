// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T08:36:04.3109919+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseSetDataEncryptionKey", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseSetDataEncryptionKeyCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the value of the data encryption key.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the operation to perform with the data encryption key.")]
        public System.Boolean ChangeEncryptionKey { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Xrm.Sdk.Messages.SetDataEncryptionKeyRequest();
                        request.EncryptionKey = EncryptionKey;
            request.ChangeEncryptionKey = ChangeEncryptionKey;
