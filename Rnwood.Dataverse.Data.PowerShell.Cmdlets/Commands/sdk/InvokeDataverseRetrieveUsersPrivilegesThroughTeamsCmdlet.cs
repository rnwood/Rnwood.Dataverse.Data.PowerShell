// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:30.6311716+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseRetrieveUsersPrivilegesThroughTeams", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseRetrieveUsersPrivilegesThroughTeamsCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the user to get the privileges for.")]
        ...
        [Parameter(HelpMessage = "Gets or sets to exclude disabled privileges.")]
        public System.Boolean ExcludeOrgDisabledPrivileges { get; set; }

        /// <summary>
        /// Gets or sets to exclude privileges based on user license and access mode.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets to exclude privileges based on user license and access mode.")]
        public System.Boolean IncludeSetupUserFiltering { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.RetrieveUsersPrivilegesThroughTeamsRequest();
                        request.UserId = UserId;
            request.ExcludeOrgDisabledPrivileges = ExcludeOrgDisabledPrivileges;
            request.IncludeSetupUserFiltering = IncludeSetupUserFiltering;
