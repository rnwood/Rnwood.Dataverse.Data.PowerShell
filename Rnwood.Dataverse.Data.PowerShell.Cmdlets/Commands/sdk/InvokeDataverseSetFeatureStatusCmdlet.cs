// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T09:08:54.0401650+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseSetFeatureStatus", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseSetFeatureStatusCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the FeatureType for the request.")]
        public System.Int32 FeatureType { get; set; }
        ...
        [Parameter(HelpMessage = "Gets or sets the ConfigData for the request.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the IsSolutionUninstall for the request.")]
        public System.Boolean IsSolutionUninstall { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.SetFeatureStatusRequest();
                        request.FeatureType = FeatureType;
            request.Status = Status;
            request.ConfigData = ConfigData;
            request.IsSolutionUninstall = IsSolutionUninstall;
