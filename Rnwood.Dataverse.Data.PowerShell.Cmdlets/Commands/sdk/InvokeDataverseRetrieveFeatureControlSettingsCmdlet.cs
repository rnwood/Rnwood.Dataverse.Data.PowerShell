// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:08:58.5636210+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseRetrieveFeatureControlSettings", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseRetrieveFeatureControlSettingsCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the NamespaceValue for the request.")]
        public System.String NamespaceValue { get; set; }

        /// <summary>
        /// Gets or sets the FeatureControlName for the request.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the FeatureControlName for the request.")]
        public System.String FeatureControlName { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.RetrieveFeatureControlSettingsRequest();
                        request.NamespaceValue = NamespaceValue;
            request.FeatureControlName = FeatureControlName;
