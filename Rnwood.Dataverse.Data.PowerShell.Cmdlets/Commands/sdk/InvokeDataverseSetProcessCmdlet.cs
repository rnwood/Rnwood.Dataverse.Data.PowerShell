// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:34:02.9080007+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseSetProcess", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseSetProcessCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = "Gets or sets the target entity. Accepts PSObject with Id and TableName/EntityName/LogicalName properties, or a string containing the entity name for lookup by name.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the business process flow definition to be set to the target entity. Accepts PSObject with Id and TableName/EntityName/LogicalName properties, or a string containing the entity name for lookup by name.")]
        public PSObject NewProcess { get; set; }
        ...
        [Parameter(HelpMessage = "Gets or sets the business process flow instance to be set as the active business process flow instance for the target entity. Optional. Accepts PSObject with Id and TableName/EntityName/LogicalName properties, or a string containing the entity name for lookup by name.")]
        public PSObject NewProcessInstance { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.SetProcessRequest();
                        request.Target = DataverseEntityConverter.ConvertPSObjectToEntityReference(Target);
            request.NewProcess = DataverseEntityConverter.ConvertPSObjectToEntityReference(NewProcess);
            request.NewProcessInstance = DataverseEntityConverter.ConvertPSObjectToEntityReference(NewProcessInstance);
