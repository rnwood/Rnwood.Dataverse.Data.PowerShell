// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:35:02.8830230+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseQualifyMemberList", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseQualifyMemberListCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the list to qualify. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets an array of IDs of the members to qualify. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets a value that indicates whether to override or remove the members from the list. Required.")]
        public System.Boolean OverrideorRemove { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.QualifyMemberListRequest();
                        request.ListId = ListId;
            request.MembersId = MembersId;
            request.OverrideorRemove = OverrideorRemove;
