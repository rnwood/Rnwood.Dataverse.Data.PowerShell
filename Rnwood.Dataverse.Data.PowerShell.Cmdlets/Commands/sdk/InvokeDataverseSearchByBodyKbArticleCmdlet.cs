// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:01:45.2854010+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    public class InvokeDataverseSearchByBodyKbArticleCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the text contained in the body of the article. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the knowledge base article subject. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets a value that indicates whether to use inflectional stem matching when searching for knowledge base articles with a specified body text. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the query criteria to find knowledge base articles with specified body text. Required.")]
