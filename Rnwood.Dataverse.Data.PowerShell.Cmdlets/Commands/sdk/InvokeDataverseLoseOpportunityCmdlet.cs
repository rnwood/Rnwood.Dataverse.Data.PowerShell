// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:53.4707712+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    public class InvokeDataverseLoseOpportunityCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the opportunity close activity. Required. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the opportunity close activity. Required. The logical name of the table/entity type for the OpportunityClose parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the opportunity close activity. Required. Properties to ignore when converting OpportunityClose PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the opportunity close activity. Required. Hashtable specifying lookup columns for entity reference conversions in OpportunityClose.")]
        ...
        [Parameter(HelpMessage = "Gets or sets a status of the opportunity. Required.")]
