// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:33:29.1624973+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseSendEmailFromTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseSendEmailFromTemplateCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the email template to use for the email.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the type of the record with which the email message is associated.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the record with which the email message is associated.")]
        ...
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = "Gets or sets the email record to send. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(Mandatory = true, HelpMessage = "Gets or sets the email record to send. The logical name of the table/entity type for the Target parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the email record to send. Properties to ignore when converting Target PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the email record to send. Hashtable specifying lookup columns for entity reference conversions in Target.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.SendEmailFromTemplateRequest();
