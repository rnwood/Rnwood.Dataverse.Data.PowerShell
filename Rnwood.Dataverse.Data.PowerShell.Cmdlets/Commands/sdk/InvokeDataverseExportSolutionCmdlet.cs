// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T16:01:50.9768773+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseExportSolution", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = "Default")]
    public class InvokeDataverseExportSolutionCmdlet : OrganizationServiceCmdlet
    {
        ...
        /// <summary>
        /// Gets or sets the path to write the exported solution file to.
        /// </summary>

        [Parameter(ParameterSetName = "ToFile", Mandatory = true, HelpMessage = "Gets or sets the path to write the exported solution file to.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            // If OutFile is specified, write the exported solution to file
            if (!string.IsNullOrEmpty(OutFile))
            {
                var exportResponse = response as Microsoft.Crm.Sdk.Messages.ExportSolutionResponse;
                if (exportResponse != null && exportResponse.ExportSolutionFile != null)
                {
                    File.WriteAllBytes(OutFile, exportResponse.ExportSolutionFile);
                    WriteVerbose($"Exported solution written to: {OutFile}");
                }
            }
            else
            {
