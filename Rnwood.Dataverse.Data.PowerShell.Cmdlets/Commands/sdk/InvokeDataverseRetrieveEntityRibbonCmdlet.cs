// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:03.0846022+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseRetrieveEntityRibbon", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseRetrieveEntityRibbonCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the logical name of an entity in order to retrieve a ribbon definition. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets a filter to retrieve a specific set of ribbon definitions for an entity. Required.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.RetrieveEntityRibbonRequest();
                        request.EntityName = EntityName;
            request.RibbonLocationFilter = RibbonLocationFilter;
