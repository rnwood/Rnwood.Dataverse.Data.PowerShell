// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:33:52.7801366+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseSendFax", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseSendFaxCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the fax to send.")]
        public System.Guid FaxId { get; set; }

        /// <summary>
        /// Gets or sets whether to send the e-mail, or to just record it as sent.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets whether to send the e-mail, or to just record it as sent.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.SendFaxRequest();
                        request.FaxId = FaxId;
