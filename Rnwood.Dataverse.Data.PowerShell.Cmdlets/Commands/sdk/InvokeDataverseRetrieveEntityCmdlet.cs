// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:35:30.9857270+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseRetrieveEntity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseRetrieveEntityCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets a filter to control how much data for the entity is retrieved.")]
        public Microsoft.Xrm.Sdk.Metadata.EntityFilters EntityFilters { get; set; }

        /// <summary>
        /// Gets or sets the logical name of the table to retrieve. Optional.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the logical name of the table to retrieve. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the unique identifier for the entity. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets whether to retrieve the table definition data that has not been published.")]
