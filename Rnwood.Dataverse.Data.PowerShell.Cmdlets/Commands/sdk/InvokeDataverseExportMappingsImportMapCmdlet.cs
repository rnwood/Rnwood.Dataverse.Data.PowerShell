// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T14:49:30.8234152+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseExportMappingsImportMap", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseExportMappingsImportMapCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the import map (data map) to export. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets a value that indicates whether to export the entity record IDs contained in the data map. Required.")]
        public System.Boolean ExportIds { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.ExportMappingsImportMapRequest();
                        request.ImportMapId = ImportMapId;
            request.ExportIds = ExportIds;
