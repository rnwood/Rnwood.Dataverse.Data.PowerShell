// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:33:01.1604083+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    public class InvokeDataverseWinOpportunityCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the opportunity close activity associated with this state change. Required. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the opportunity close activity associated with this state change. Required. The logical name of the table/entity type for the OpportunityClose parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the opportunity close activity associated with this state change. Required. Properties to ignore when converting OpportunityClose PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the opportunity close activity associated with this state change. Required. Hashtable specifying lookup columns for entity reference conversions in OpportunityClose.")]
        ...
        [Parameter(HelpMessage = "Gets or sets a new status of the opportunity. Required.")]
