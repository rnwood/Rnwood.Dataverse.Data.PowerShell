// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:49:18.0463676+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseRetrieveAadUserSetOfPrivilegesByIds", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseRetrieveAadUserSetOfPrivilegesByIdsCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the Directory Object.")]
        public System.Guid DirectoryObjectId { get; set; }

        /// <summary>
        /// Gets or sets the PrivilegeIds for the request.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the PrivilegeIds for the request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.RetrieveAadUserSetOfPrivilegesByIdsRequest();
