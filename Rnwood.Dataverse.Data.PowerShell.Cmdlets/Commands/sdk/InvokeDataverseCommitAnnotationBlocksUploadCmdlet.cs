// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T20:29:00.5850490+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseCommitAnnotationBlocksUpload", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseCommitAnnotationBlocksUploadCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = "Gets or sets the target entity. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(Mandatory = true, HelpMessage = "Gets or sets the target entity. The logical name of the table/entity type for the Target parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the target entity. Properties to ignore when converting Target PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the target entity. Hashtable specifying lookup columns for entity reference conversions in Target.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the IDs of the uploaded data blocks, in the correct sequence, that will result in the final annotation when the data blocks are combined.")]
        public System.String[] BlockList { get; set; }

        /// <summary>
        /// Gets or sets a token that uniquely identifies a sequence of related data uploads.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets a token that uniquely identifies a sequence of related data uploads.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.CommitAnnotationBlocksUploadRequest();
