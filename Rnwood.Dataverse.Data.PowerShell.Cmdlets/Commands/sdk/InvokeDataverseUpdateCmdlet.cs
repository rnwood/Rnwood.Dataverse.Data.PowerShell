// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T08:36:06.9370785+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    public class InvokeDataverseUpdateCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = "Gets or sets the target that is the record to which the related records are associated. Required. Accepts PSObject with Id and TableName/EntityName/LogicalName properties, or a string containing the entity name for lookup by name. The logical name of the table/entity type for the Target parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the target that is the record to which the related records are associated. Required. Accepts PSObject with Id and TableName/EntityName/LogicalName properties, or a string containing the entity name for lookup by name. Properties to ignore when converting Target PSObject to Entity.")]
