// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:23:55.5694268+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseUpdate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseUpdateCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = "Gets or sets an instance of an entity that is used to update a record. Required. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(Mandatory = true, HelpMessage = "Gets or sets an instance of an entity that is used to update a record. Required. The logical name of the table/entity type for the Target parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets an instance of an entity that is used to update a record. Required. Properties to ignore when converting Target PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets an instance of an entity that is used to update a record. Required. Hashtable specifying lookup columns for entity reference conversions in Target.")]
