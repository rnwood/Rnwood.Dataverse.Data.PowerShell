// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:31:16.8489245+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseAddRecurrence", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseAddRecurrenceCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = "Gets or sets the target, which is a recurring appointment master record to which the appointment is converted. Required. The logical name of the table/entity type for the Target parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the target, which is a recurring appointment master record to which the appointment is converted. Required. Properties to ignore when converting Target PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the target, which is a recurring appointment master record to which the appointment is converted. Required. Hashtable specifying lookup columns for entity reference conversions in Target.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the appointment that needs to be converted into a recurring appointment. Required.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.AddRecurrenceRequest();
