// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T06:55:59.2874511+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseInitializeFrom", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseInitializeFromCmdlet : OrganizationServiceCmdlet
    {
        ...
        public PSObject EntityMoniker { get; set; }

        /// <summary>
        /// Gets or sets the logical name of the target entity.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the logical name of the target entity.")]
        public System.String TargetEntityName { get; set; }

        /// <summary>
        /// Gets or sets which attributes are to be initialized in the initialized instance.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets which attributes are to be initialized in the initialized instance.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the SkipParentalRelationshipMapping for the request.")]
        public System.Boolean SkipParentalRelationshipMapping { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.InitializeFromRequest();
                        request.EntityMoniker = DataverseEntityConverter.ConvertPSObjectToEntityReference(EntityMoniker);
            request.TargetEntityName = TargetEntityName;
            request.TargetFieldType = TargetFieldType;
            request.SkipParentalRelationshipMapping = SkipParentalRelationshipMapping;
