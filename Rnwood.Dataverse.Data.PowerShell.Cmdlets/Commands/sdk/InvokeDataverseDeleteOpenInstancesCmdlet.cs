// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T20:29:20.6623179+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseDeleteOpenInstances", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseDeleteOpenInstancesCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = "Gets or sets the target record for the operation. Required. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(Mandatory = true, HelpMessage = "Gets or sets the target record for the operation. Required. The logical name of the table/entity type for the Target parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the target record for the operation. Required. Properties to ignore when converting Target PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the target record for the operation. Required. Hashtable specifying lookup columns for entity reference conversions in Target.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the end date for the recurring appointment series. Required.")]
        public System.DateTime SeriesEndDate { get; set; }

        /// <summary>
        /// Gets or sets the value to be used to set the status of appointment instances that have already passed. Required.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the value to be used to set the status of appointment instances that have already passed. Required.")]
        public System.Int32 StateOfPastInstances { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.DeleteOpenInstancesRequest();
            ...
            request.SeriesEndDate = SeriesEndDate;
            request.StateOfPastInstances = StateOfPastInstances;
