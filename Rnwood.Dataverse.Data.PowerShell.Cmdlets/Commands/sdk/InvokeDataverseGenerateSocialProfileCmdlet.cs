// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:31:18.5033737+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    public class InvokeDataverseGenerateSocialProfileCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the social profile instance to return or generate. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the social profile instance to return or generate. The logical name of the table/entity type for the Entity parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the social profile instance to return or generate. Properties to ignore when converting Entity PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the social profile instance to return or generate. Hashtable specifying lookup columns for entity reference conversions in Entity.")]
