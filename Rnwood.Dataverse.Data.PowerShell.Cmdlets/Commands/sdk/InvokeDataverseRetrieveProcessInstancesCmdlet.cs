// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:05.0363321+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseRetrieveProcessInstances", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseRetrieveProcessInstancesCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the Id of the entity record for which you want to retrieve all the business process flow instances across all business process flow definitions.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the logical name of the entity for which you want to retrieve all the business process flow instances across all business process flow definitions.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.RetrieveProcessInstancesRequest();
