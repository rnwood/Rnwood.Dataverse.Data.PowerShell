// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:33:23.1130358+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseCheckPromoteEmail", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseCheckPromoteEmailCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the message ID that is contained in the email header. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the subject of the message. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the direction of a mail checked for promotion for uniqueness.")]
        public System.Int32 DirectionCode { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.CheckPromoteEmailRequest();
                        request.MessageId = MessageId;
            request.Subject = Subject;
            request.DirectionCode = DirectionCode;
