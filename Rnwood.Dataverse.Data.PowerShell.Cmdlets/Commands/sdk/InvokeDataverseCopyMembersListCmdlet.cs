// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T06:56:30.0044634+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseCopyMembersList", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseCopyMembersListCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the source list. Required.")]
        public System.Guid SourceListId { get; set; }

        /// <summary>
        /// Gets or sets the ID of the target list. Required.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the ID of the target list. Required.")]
        public System.Guid TargetListId { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.CopyMembersListRequest();
                        request.SourceListId = SourceListId;
            request.TargetListId = TargetListId;
