// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T20:30:11.5543681+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseSetParentBusinessUnit", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseSetParentBusinessUnitCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets the GUIDGUID of the business unit that the user making the request, also known as the calling user, belongs to.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the new parent business unit.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.SetParentBusinessUnitRequest();
