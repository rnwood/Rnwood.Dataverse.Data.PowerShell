// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:31.3231346+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseReplacePrivilegesRole", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseReplacePrivilegesRoleCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the role for which the privileges are to be replaced.")]
        ...
        [Parameter(HelpMessage = "Gets or sets an array that contains the IDs and depths of the privileges that replace the existing privileges.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.ReplacePrivilegesRoleRequest();
