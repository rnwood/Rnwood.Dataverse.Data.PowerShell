// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-06T19:49:38.5569199+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseCloneAsSolution", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseCloneAsSolutionCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the unique name of the parent solution.")]
        public System.String ParentSolutionUniqueName { get; set; }

        /// <summary>
        /// Gets or sets the display name for the attribute.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the display name for the attribute.")]
        ...
        [Parameter(HelpMessage = "Specifies to display the string as a version number. Value = 6.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.CloneAsSolutionRequest();
                        request.ParentSolutionUniqueName = ParentSolutionUniqueName;
