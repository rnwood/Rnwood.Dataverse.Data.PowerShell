// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T21:02:58.5644314+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseStageAndUpgradeAsync", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = "Default")]
    public class InvokeDataverseStageAndUpgradeAsyncCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Whether any unmanaged customizations that have been applied over existing managed solution components should be overwritten. Required.")]
        ...
        [Parameter(HelpMessage = "Whether any processes (workflows) included in the solution should be activated after they are imported. Required.")]
        ...
        [Parameter(ParameterSetName = "Default", HelpMessage = "The compressed solutions file to import. Required.")]
        ...
        [Parameter(HelpMessage = "Whether enforcement of dependencies related to product updates should be skipped.")]
        ...
        [Parameter(HelpMessage = "List of entities to overwrite values from the solution.")]
        ...
        [Parameter(HelpMessage = "Additional solution parameters.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.StageAndUpgradeAsyncRequest();
