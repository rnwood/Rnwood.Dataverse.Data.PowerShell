// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:33:50.7704353+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseIsValidStateTransition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseIsValidStateTransitionCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the entity reference for the record whose transition state is validated. Accepts PSObject with Id and TableName/EntityName/LogicalName properties, or a string containing the entity name for lookup by name.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the proposed new state for the record.")]
        public System.String NewState { get; set; }

        /// <summary>
        /// Gets or sets the proposed new status for the record.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets the proposed new status for the record.")]
        public System.Int32 NewStatus { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest();
