// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-08T20:29:03.1257944+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    public class InvokeDataverseCheckIncomingEmailCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "For internal use only. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(HelpMessage = "For internal use only. The logical name of the table/entity type for the ExtraProperties parameter.")]
        ...
        [Parameter(HelpMessage = "For internal use only. Properties to ignore when converting ExtraProperties PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "For internal use only. Hashtable specifying lookup columns for entity reference conversions in ExtraProperties.")]
