// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T14:50:20.0140104+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseCopyCampaign", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseCopyCampaignCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the base campaign to copy from. Required.")]
        public System.Guid BaseCampaign { get; set; }

        /// <summary>
        /// Gets or sets a value that indicates whether to save the campaign as a template. Required.
        /// </summary>

        [Parameter(HelpMessage = "Gets or sets a value that indicates whether to save the campaign as a template. Required.")]
        public System.Boolean SaveAsTemplate { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.CopyCampaignRequest();
                        request.BaseCampaign = BaseCampaign;
            request.SaveAsTemplate = SaveAsTemplate;
