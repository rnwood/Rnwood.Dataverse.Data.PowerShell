// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:32:00.1537505+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseQueryMultipleSchedules", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseQueryMultipleSchedulesCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the start of the time slot. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the end time for the scheduled block of time. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the time codes to look for: Available, Busy, Unavailable, or Filter, which correspond to the resource IDs. Required.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.QueryMultipleSchedulesRequest();
                        request.ResourceIds = ResourceIds;
            request.Start = Start;
            request.End = End;
            request.TimeCodes = TimeCodes;
