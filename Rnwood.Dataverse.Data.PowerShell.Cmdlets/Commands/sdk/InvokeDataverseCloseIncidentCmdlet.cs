// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T07:26:36.9462265+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseCloseIncident", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseCloseIncidentCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the incident resolution (case resolution) that is associated with the incident (case) to be closed. Required. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the incident resolution (case resolution) that is associated with the incident (case) to be closed. Required. The logical name of the table/entity type for the IncidentResolution parameter.")]
        [ArgumentCompleter(typeof(TableNameArgumentCompleter))]
        public string IncidentResolutionTableName { get; set; }
        ...
        [Parameter(HelpMessage = "Gets or sets the incident resolution (case resolution) that is associated with the incident (case) to be closed. Required. Properties to ignore when converting IncidentResolution PSObject to Entity.")]
        [ArgumentCompleter(typeof(Rnwood.Dataverse.Data.PowerShell.Commands.PSObjectPropertyNameArgumentCompleter))]
        public string[] IncidentResolutionIgnoreProperties { get; set; }
        ...
        [Parameter(HelpMessage = "Gets or sets the incident resolution (case resolution) that is associated with the incident (case) to be closed. Required. Hashtable specifying lookup columns for entity reference conversions in IncidentResolution.")]
        public Hashtable IncidentResolutionLookupColumns { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.CloseIncidentRequest();
                        { var options = new ConvertToDataverseEntityOptions(); if (IncidentResolutionIgnoreProperties != null) { foreach (string prop in IncidentResolutionIgnoreProperties) { options.IgnoredPropertyName.Add(prop); } } if (IncidentResolutionLookupColumns != null) { foreach (DictionaryEntry entry in IncidentResolutionLookupColumns) { options.ColumnOptions[(string)entry.Key] = new ConvertToDataverseEntityColumnOptions() { LookupColumn = (string)entry.Value }; } } request.IncidentResolution = entityConverter.ConvertToDataverseEntity(IncidentResolution, IncidentResolutionTableName, options); }
