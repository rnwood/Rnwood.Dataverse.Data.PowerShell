// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:33:43.7728967+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseRetrieveTimelineWallRecords", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseRetrieveTimelineWallRecordsCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the FetchXML query.")]
        ...
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = "Gets or sets the Timeline Wall entity reference. Accepts PSObject with Id and TableName/EntityName/LogicalName properties, or a string containing the entity name for lookup by name.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the type of rollup (0=None, 1=Related, and 2=Extended).")]
        public System.Int32 RollupType { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.RetrieveTimelineWallRecordsRequest();
