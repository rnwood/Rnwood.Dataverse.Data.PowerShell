// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-09T12:31:39.5446429+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseCreateWorkflowFromTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseCreateWorkflowFromTemplateCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the name of the new workflow. Required.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the ID of the workflow template. Required.")]
        public System.Guid WorkflowTemplateId { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.CreateWorkflowFromTemplateRequest();
                        request.WorkflowName = WorkflowName;
            request.WorkflowTemplateId = WorkflowTemplateId;
