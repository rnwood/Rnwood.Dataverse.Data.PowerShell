// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-30T08:17:11.6965647+00:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseInsertOptionValue", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseInsertOptionValueCmdlet : OrganizationServiceCmdlet
    {
        ...
        [Parameter(HelpMessage = "Gets or sets the name of the global option set. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the name of the column when updating a local choice column. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the table logical name when updating the local option set in a choice column. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the value for the option. Optional.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the unique name of the unmanaged solution when updating a choice. Optional.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Xrm.Sdk.Messages.InsertOptionValueRequest();
