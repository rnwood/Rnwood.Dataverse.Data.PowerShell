// <auto-generated>
//     This code was generated by GenerateRequestCmdlets.ps1 (version 1.0.0) on 2025-10-04T15:35:07.4373153+01:00.
...
namespace Rnwood.Dataverse.Data.PowerShell.Commands.Sdk
{
    ...
    [Cmdlet("Invoke", "DataverseCancelSalesOrder", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    public class InvokeDataverseCancelSalesOrderCmdlet : OrganizationServiceCmdlet
    {
                /// <summary>
        ...
        [Parameter(HelpMessage = "Gets or sets the close activity that is associated with the sales order (order) that you want to cancel. Required. Accepts PSObject with properties that will be converted to Entity. Use corresponding TableName parameter to specify the entity type.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the close activity that is associated with the sales order (order) that you want to cancel. Required. The logical name of the table/entity type for the OrderClose parameter.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the close activity that is associated with the sales order (order) that you want to cancel. Required. Properties to ignore when converting OrderClose PSObject to Entity.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the close activity that is associated with the sales order (order) that you want to cancel. Required. Hashtable specifying lookup columns for entity reference conversions in OrderClose.")]
        ...
        [Parameter(HelpMessage = "Gets or sets the status of the sales order (order). Required.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new Microsoft.Crm.Sdk.Messages.CancelSalesOrderRequest();
