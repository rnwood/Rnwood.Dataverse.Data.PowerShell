...
{
    [Cmdlet(VerbsData.Import, "DataverseSolutionAsync", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(ImportSolutionAsyncResponse))]
    ///<summary>Executes ImportSolutionAsyncRequest SDK message.</summary>
    public class ImportDataverseSolutionAsyncCmdlet : OrganizationServiceCmdlet
    {
