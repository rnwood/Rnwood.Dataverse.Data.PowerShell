...
{
    [Cmdlet(VerbsCommon.Set, "DataverseAndUpgrade", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(StageAndUpgradeResponse))]
    ///<summary>Executes StageAndUpgradeRequest SDK message.</summary>
    public class SetDataverseAndUpgradeCmdlet : OrganizationServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var request = new StageAndUpgradeRequest();
            ...
            if (ShouldProcess("Executing StageAndUpgradeRequest", "StageAndUpgradeRequest"))
            {
                var response = (StageAndUpgradeResponse)Connection.Execute(request);
