...
{
    [Cmdlet(VerbsData.Export, "DataverseSolution")]
    [OutputType(typeof(ExportSolutionResponse))]
    ///<summary>Executes ExportSolutionRequest SDK message.</summary>
    public class ExportDataverseSolutionCmdlet : OrganizationServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var response = (ExportSolutionResponse)Connection.Execute(request);
