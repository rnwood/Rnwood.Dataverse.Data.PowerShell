...
{
    [Cmdlet(VerbsLifecycle.Complete, "DataverseSalesOrder")]
    [OutputType(typeof(FulfillSalesOrderResponse))]
    ///<summary>Executes FulfillSalesOrderRequest SDK message.</summary>
    public class CompleteDataverseSalesOrderCmdlet : OrganizationServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var response = (FulfillSalesOrderResponse)Connection.Execute(request);
