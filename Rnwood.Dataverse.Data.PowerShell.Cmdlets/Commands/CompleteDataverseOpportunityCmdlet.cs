...
{
    [Cmdlet(VerbsLifecycle.Complete, "DataverseOpportunity")]
    [OutputType(typeof(WinOpportunityResponse))]
    ///<summary>Executes WinOpportunityRequest SDK message.</summary>
    public class CompleteDataverseOpportunityCmdlet : OrganizationServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var response = (WinOpportunityResponse)Connection.Execute(request);
