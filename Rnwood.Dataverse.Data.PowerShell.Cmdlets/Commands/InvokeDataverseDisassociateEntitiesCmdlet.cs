...
{
    [Cmdlet(VerbsLifecycle.Invoke, "DataverseDisassociateEntities")]
    [OutputType(typeof(DisassociateEntitiesResponse))]
    ///<summary>Executes DisassociateEntitiesRequest SDK message.</summary>
    public class InvokeDataverseDisassociateEntitiesCmdlet : OrganizationServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var response = (DisassociateEntitiesResponse)Connection.Execute(request);
