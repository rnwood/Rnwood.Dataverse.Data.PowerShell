...
- **XrmToolbox Plugin**: Embedded PowerShell console directly within XrmToolbox tabs using ConEmu control. See [XrmToolbox Plugin README](Rnwood.Dataverse.Data.PowerShell.XrmToolboxPlugin/README.md) for details.
