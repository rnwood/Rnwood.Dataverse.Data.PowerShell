...
- **XrmToolbox Plugin**: Embedded PowerShell console directly within XrmToolbox tabs with automatic connection bridging. See [XrmToolbox Plugin README](Rnwood.Dataverse.Data.PowerShell.XrmToolboxPlugin/README.md) for details.
