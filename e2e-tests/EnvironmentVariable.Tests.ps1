        ...
        pwsh -noninteractive -noprofile -command {
            ...
            try {
                ...
                try {
                    ...
                    Write-Host "Created definition with ID: $($createdDef.environmentvariabledefinitionid)"
                    ...
                    Write-Host "SUCCESS: Environment variable value was set correctly"
                    
                } finally {
                    # Cleanup
                    Write-Host "Cleaning up..."
                    try {
                        Remove-DataverseEnvironmentVariableValue -Connection $connection -SchemaName $schemaName -Confirm:$false -ErrorAction SilentlyContinue
                    } catch { }
                    try {
        ...
        pwsh -noninteractive -noprofile -command {
            ...
            try {
                ...
                try {
                    ...
                    Write-Host "SUCCESS: Environment variable value was updated correctly"
        ...
        pwsh -noninteractive -noprofile -command {
            ...
            try {
                ...
                try {
                    ...
                    Write-Host "SUCCESS: Environment variable value was updated correctly even with mismatched schemaname"
                    
                } finally {
                    # Cleanup
                    Write-Host "Cleaning up..."
                    try {
                        # Use SQL to delete by definition ID since schemaname may not match
                        Invoke-DataverseSql -Connection $connection -Sql "DELETE FROM environmentvariablevalue WHERE environmentvariabledefinitionid = '$defId'" -ErrorAction SilentlyContinue
                    } catch { }
                    try {
                        Remove-DataverseEnvironmentVariableDefinition -Connection $connection -SchemaName $schemaName -Confirm:$false -ErrorAction SilentlyContinue
                    } catch { }
        ...
        pwsh -noninteractive -noprofile -command {
            ...
            try {
                ...
                try {
                    ...
                    Write-Host "SUCCESS: Get-DataverseEnvironmentVariableValue correctly found and returned the value"
        ...
        pwsh -noninteractive -noprofile -command {
            ...
            try {
                ...
                try {
                    ...
                    Write-Host "SUCCESS: Remove-DataverseEnvironmentVariableValue correctly removed the value"
        ...
        pwsh -noninteractive -noprofile -command {
            ...
            try {
                ...
                try {
                    ...
                    Write-Host "SUCCESS: Multiple environment variable values were set correctly"
                    
                } finally {
                    # Cleanup
                    Write-Host "Cleaning up..."
                    try {
                        if ($defId1) { Invoke-DataverseSql -Connection $connection -Sql "DELETE FROM environmentvariablevalue WHERE environmentvariabledefinitionid = '$defId1'" -ErrorAction SilentlyContinue }
                    } catch { }
                    try {
                        if ($defId2) { Invoke-DataverseSql -Connection $connection -Sql "DELETE FROM environmentvariablevalue WHERE environmentvariabledefinitionid = '$defId2'" -ErrorAction SilentlyContinue }
                    } catch { }
                    try {
                        Remove-DataverseEnvironmentVariableDefinition -Connection $connection -SchemaName $schemaName1 -Confirm:$false -ErrorAction SilentlyContinue
                    } catch { }
                    try {
                        Remove-DataverseEnvironmentVariableDefinition -Connection $connection -SchemaName $schemaName2 -Confirm:$false -ErrorAction SilentlyContinue
                    } catch { }
                }
            } catch {
                # Format error with full details using Format-List with large width to avoid truncation
