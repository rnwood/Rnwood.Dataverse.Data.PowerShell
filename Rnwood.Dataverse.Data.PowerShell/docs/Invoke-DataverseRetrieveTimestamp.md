...
# Invoke-DataverseRetrieveTimestamp
...
```
Invoke-DataverseRetrieveTimestamp -Connection <ServiceClient> [-ProgressAction <ActionPreference>] [-WhatIf]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseRetrieveTimestamp -Connection <ServiceClient>
```
