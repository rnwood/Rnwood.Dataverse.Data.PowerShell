...
```
Invoke-DataverseConvertQuoteToSalesOrder -Connection <ServiceClient> -QuoteId <Guid> -ColumnSet <ColumnSet> -QuoteCloseDate <DateTime> -QuoteCloseStatus <OptionSetValue> -QuoteCloseSubject <String> -QuoteCloseDescription <String> -ProcessInstanceId <PSObject>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.ConvertQuoteToSalesOrderResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.ConvertQuoteToSalesOrderResponse)
## NOTES
