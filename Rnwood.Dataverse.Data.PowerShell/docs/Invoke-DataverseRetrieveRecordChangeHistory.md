...
```
Invoke-DataverseRetrieveRecordChangeHistory -Connection <ServiceClient> -Target <PSObject> -PagingInfo <PagingInfo>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.RetrieveRecordChangeHistoryResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.RetrieveRecordChangeHistoryResponse)
## NOTES
