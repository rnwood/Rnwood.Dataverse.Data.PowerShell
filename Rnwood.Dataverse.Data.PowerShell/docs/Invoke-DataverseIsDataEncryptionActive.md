...
# Invoke-DataverseIsDataEncryptionActive
...
```
Invoke-DataverseIsDataEncryptionActive -Connection <ServiceClient> [-ProgressAction <ActionPreference>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseIsDataEncryptionActive -Connection <ServiceClient>
```
