...
### Example 1
```powershell
PS C:\> Invoke-DataverseUpdate -Connection <ServiceClient> -Target <PSObject> -TargetTableName <String> -TargetIgnoreProperties <String[]> -TargetLookupColumns <Hashtable> -ConcurrencyBehavior <ConcurrencyBehavior>
```
