...
```
Invoke-DataverseImportFieldTranslation -Connection <ServiceClient> [-TranslationFile <Byte[]>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseImportFieldTranslation -Connection <ServiceClient> -TranslationFile <Byte[]>
```
