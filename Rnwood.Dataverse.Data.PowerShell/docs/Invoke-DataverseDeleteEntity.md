...
```
Invoke-DataverseDeleteEntity -Connection <ServiceClient> [-LogicalName <String>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseDeleteEntity -Connection <ServiceClient> -LogicalName <String>
```
