# Lock-DataverseInvoicePricing

## SYNOPSIS
Locks pricing for an invoice to prevent automatic price recalculations.

## SYNTAX

```
Lock-DataverseInvoicePricing -Connection <ServiceClient> [<CommonParameters>]
```
