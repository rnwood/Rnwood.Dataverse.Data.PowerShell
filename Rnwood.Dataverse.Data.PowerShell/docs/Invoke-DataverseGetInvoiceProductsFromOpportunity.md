...
```
Invoke-DataverseGetInvoiceProductsFromOpportunity -Connection <ServiceClient> -OpportunityId <Guid> -InvoiceId <Guid>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.GetInvoiceProductsFromOpportunityResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.GetInvoiceProductsFromOpportunityResponse)
## NOTES
