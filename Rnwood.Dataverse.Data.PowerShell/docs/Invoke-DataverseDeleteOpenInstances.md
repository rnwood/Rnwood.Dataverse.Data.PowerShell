...
# Invoke-DataverseDeleteOpenInstances
...
### Example 1
```powershell
PS C:\> Invoke-DataverseDeleteOpenInstances -Connection <ServiceClient> -Target <PSObject> -TargetTableName <String> -TargetIgnoreProperties <String[]> -TargetLookupColumns <Hashtable> -SeriesEndDate <DateTime> -StateOfPastInstances <Int32>
```
