...
# Invoke-DataverseDeleteEntityKey
...
```
Invoke-DataverseDeleteEntityKey [-Name <String>] [-EntityLogicalName <String>] [-Connection <ServiceClient>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseDeleteEntityKey -Connection <ServiceClient> -Name <String> -EntityLogicalName <String>
```
