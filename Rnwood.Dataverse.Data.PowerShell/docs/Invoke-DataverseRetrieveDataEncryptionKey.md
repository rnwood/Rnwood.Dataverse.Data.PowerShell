...
# Invoke-DataverseRetrieveDataEncryptionKey
...
```
Invoke-DataverseRetrieveDataEncryptionKey -Connection <ServiceClient> [-ProgressAction <ActionPreference>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseRetrieveDataEncryptionKey -Connection <ServiceClient>
```
