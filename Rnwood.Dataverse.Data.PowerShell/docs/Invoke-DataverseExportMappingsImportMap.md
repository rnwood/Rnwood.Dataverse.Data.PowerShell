...
```
Invoke-DataverseExportMappingsImportMap -Connection <ServiceClient> -ImportMapId <Guid> -ExportIds <Boolean>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.ExportMappingsImportMapResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.ExportMappingsImportMapResponse)
## NOTES
