...
# Invoke-DataverseDeleteOptionValue
...
### Example 1
```powershell
PS C:\> Invoke-DataverseDeleteOptionValue -Connection <ServiceClient> -OptionSetName <String> -AttributeLogicalName <String> -EntityLogicalName <String> -Value <Int32> -SolutionUniqueName <String>
```
