...
```
Invoke-DataverseRetrieveAttribute [-EntityLogicalName <String>] [-LogicalName <String>] [-ColumnNumber <Int32>]
 [-MetadataId <Guid>] [-RetrieveAsIfPublished <Boolean>] [-Connection <ServiceClient>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseRetrieveAttribute -Connection <ServiceClient> -EntityLogicalName <String> -LogicalName <String> -ColumnNumber <Int32> -MetadataId <Guid> -RetrieveAsIfPublished <Boolean>
```
