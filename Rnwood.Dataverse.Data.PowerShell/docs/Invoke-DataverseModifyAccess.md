...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.ModifyAccessRequest](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.ModifyAccessRequest)

## SYNTAX

```
Invoke-DataverseModifyAccess -Connection <ServiceClient> -Target <PSObject> -PrincipalAccess <PrincipalAccess>
```
...
### Example 1
```powershell
PS C:\> Invoke-DataverseModifyAccess -Connection <ServiceClient> -Target <PSObject> -PrincipalAccess <PrincipalAccess>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.ModifyAccessResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.ModifyAccessResponse)
## NOTES
