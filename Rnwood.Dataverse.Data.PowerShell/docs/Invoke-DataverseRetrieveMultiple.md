...
```
Invoke-DataverseRetrieveMultiple -Connection <ServiceClient> [-Query <QueryBase>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseRetrieveMultiple -Connection <ServiceClient> -Query <QueryBase>
```
