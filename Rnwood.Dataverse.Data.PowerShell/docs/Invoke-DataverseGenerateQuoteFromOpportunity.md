...
```
Invoke-DataverseGenerateQuoteFromOpportunity -Connection <ServiceClient> -OpportunityId <Guid> -ColumnSet <ColumnSet> -ProcessInstanceId <PSObject>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.GenerateQuoteFromOpportunityResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.GenerateQuoteFromOpportunityResponse)
## NOTES
