...
### Id
```
Remove-DataverseWebResource -Id <Guid> [-IfExists] [-Connection <ServiceClient>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name
```
Remove-DataverseWebResource -Name <String> [-IfExists] [-Connection <ServiceClient>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### InputObject
```
Remove-DataverseWebResource -InputObject <PSObject> [-IfExists] [-Connection <ServiceClient>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### -Id
ID of the web resource to delete
...
### -IfExists
If set, suppresses errors if the web resource doesn't exist
...
### -InputObject
Web resource object to delete (from pipeline)
...
### -Name
Name of the web resource to delete
