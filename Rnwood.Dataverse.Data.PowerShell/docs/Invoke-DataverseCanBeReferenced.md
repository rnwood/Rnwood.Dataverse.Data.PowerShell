...
# Invoke-DataverseCanBeReferenced
...
```
Invoke-DataverseCanBeReferenced -Connection <ServiceClient> [-EntityName <String>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseCanBeReferenced -Connection <ServiceClient> -EntityName <String>
```
