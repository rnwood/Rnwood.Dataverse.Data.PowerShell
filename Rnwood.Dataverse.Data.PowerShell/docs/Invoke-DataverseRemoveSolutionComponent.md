...
# Invoke-DataverseRemoveSolutionComponent
...
```
Invoke-DataverseRemoveSolutionComponent -Connection <ServiceClient> -ComponentId <Guid> -ComponentType <Int32> -SolutionUniqueName <String>
```
...
### Example 1
```powershell
PS C:\> Invoke-DataverseRemoveSolutionComponent -Connection <ServiceClient> -ComponentId <Guid> -ComponentType <Int32> -SolutionUniqueName <String>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.RemoveSolutionComponentResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.RemoveSolutionComponentResponse)
## NOTES
