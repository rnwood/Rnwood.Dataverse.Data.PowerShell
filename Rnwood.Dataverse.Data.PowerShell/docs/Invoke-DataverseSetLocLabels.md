...
```
Invoke-DataverseSetLocLabels -Connection <ServiceClient> -EntityMoniker <PSObject> -AttributeName <String> -Labels <LocalizedLabel[]>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.SetLocLabelsResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.SetLocLabelsResponse)
## NOTES
