...
```
Invoke-DataverseRevertProduct -Connection <ServiceClient> -Target <PSObject>
```
...
### Example 1
```powershell
PS C:\> Invoke-DataverseRevertProduct -Connection <ServiceClient> -Target <PSObject>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.RevertProductResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.RevertProductResponse)
## NOTES
