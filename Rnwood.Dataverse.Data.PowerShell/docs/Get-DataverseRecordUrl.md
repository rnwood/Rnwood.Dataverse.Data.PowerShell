...
The cmdlet can optionally include parameters to open the record in a specific app or with a specific form.
...
### Example 3: Get URL for a record in a specific app
```powershell
...
Returns a URL to open the contact record in the specified model-driven app.

### Example 4: Get URL with a specific form
```powershell
...
### Example 5: Generate URLs from pipeline
```powershell
