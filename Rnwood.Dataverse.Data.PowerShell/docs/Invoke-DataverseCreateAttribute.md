...
# Invoke-DataverseCreateAttribute
...
```
Invoke-DataverseCreateAttribute -Connection <ServiceClient> [-Attribute <AttributeMetadata>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseCreateAttribute -Connection <ServiceClient> -Attribute <AttributeMetadata> -EntityName <String> -SolutionUniqueName <String>
```
