...
```
Invoke-DataverseAddUserToRecordTeam -Connection <ServiceClient> -Record <PSObject> -TeamTemplateId <Guid> -SystemUserId <Guid>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.AddUserToRecordTeamResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.AddUserToRecordTeamResponse)
## NOTES
