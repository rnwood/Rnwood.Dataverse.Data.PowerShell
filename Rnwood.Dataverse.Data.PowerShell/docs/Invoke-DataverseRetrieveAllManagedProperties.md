...
# Invoke-DataverseRetrieveAllManagedProperties
...
```
Invoke-DataverseRetrieveAllManagedProperties [-Connection <ServiceClient>] [-ProgressAction <ActionPreference>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseRetrieveAllManagedProperties -Connection <ServiceClient>
```
