...
```
Invoke-DataverseGetQuantityDecimal -Connection <ServiceClient> -Target <PSObject> [-ProductId <Guid>]
 [-UoMId <Guid>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
