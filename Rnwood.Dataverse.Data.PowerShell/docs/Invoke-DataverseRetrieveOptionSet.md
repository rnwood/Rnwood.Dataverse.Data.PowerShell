...
# Invoke-DataverseRetrieveOptionSet
...
### Example 1
```powershell
PS C:\> Invoke-DataverseRetrieveOptionSet -Connection <ServiceClient> -Name <String> -MetadataId <Guid> -RetrieveAsIfPublished <Boolean>
```
