...
# Invoke-DataverseDeleteRelationship
...
```
Invoke-DataverseDeleteRelationship -Connection <ServiceClient> [-Name <String>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseDeleteRelationship -Connection <ServiceClient> -Name <String>
```
