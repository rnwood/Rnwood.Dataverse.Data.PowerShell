...
```
Invoke-DataverseSyncBulkOperation -Connection <ServiceClient> -QuerySet <QueryExpression[]> -OperationType <Int32>
```
...
### Microsoft.Crm.Sdk.Messages.SyncBulkOperationResponse
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.SyncBulkOperationResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.SyncBulkOperationResponse)
## NOTES
