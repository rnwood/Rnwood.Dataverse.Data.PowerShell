...
```
Remove-DataversePluginPackage -Id <Guid> [-IfExists] [-Connection <ServiceClient>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
Deletes a plugin package from Dataverse.
...
### -Id
ID of the plugin package to remove
...
### -IfExists
If specified, the cmdlet will not raise an error if the package does not exist
