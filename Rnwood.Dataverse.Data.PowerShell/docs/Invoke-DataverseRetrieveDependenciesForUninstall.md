...
```
Invoke-DataverseRetrieveDependenciesForUninstall -Connection <ServiceClient> -SolutionUniqueName <String>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.RetrieveDependenciesForUninstallResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.RetrieveDependenciesForUninstallResponse)
## NOTES
