...
```
Invoke-DataverseSearchByBodyKbArticle -Connection <ServiceClient> -SearchText <String> -SubjectId <Guid> -UseInflection <Boolean> -QueryExpression <QueryBase>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.SearchByBodyKbArticleResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.SearchByBodyKbArticleResponse)
## NOTES
