...
```
Invoke-DataverseCreate -Connection <ServiceClient> -Target <PSObject> -TargetTableName <String> -TargetIgnoreProperties <String[]> -TargetLookupColumns <Hashtable>
```
...
[Microsoft Learn: Microsoft.Xrm.Sdk.Messages.CreateResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Xrm.Sdk.Messages.CreateResponse)
## NOTES
