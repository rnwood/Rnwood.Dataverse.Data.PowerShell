...
# Invoke-DataverseDeleteOptionSet
...
```
Invoke-DataverseDeleteOptionSet -Connection <ServiceClient> [-Name <String>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseDeleteOptionSet -Connection <ServiceClient> -Name <String>
```
