...
```
Invoke-DataverseAddRecurrence -Connection <ServiceClient> -Target <PSObject> -TargetTableName <String>
 [-TargetIgnoreProperties <String[]>] [-TargetLookupColumns <Hashtable>] [-AppointmentId <Guid>]
