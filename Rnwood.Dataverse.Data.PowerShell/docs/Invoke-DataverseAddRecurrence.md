...
```
Invoke-DataverseAddRecurrence -Connection <ServiceClient> -Target <PSObject> -TargetTableName <String> -TargetIgnoreProperties <String[]> -TargetLookupColumns <Hashtable> -AppointmentId <Guid>
```
...
[Microsoft Learn: Microsoft.Crm.Sdk.Messages.AddRecurrenceResponse](https://learn.microsoft.com/dotnet/api/Microsoft.Crm.Sdk.Messages.AddRecurrenceResponse)
## NOTES
