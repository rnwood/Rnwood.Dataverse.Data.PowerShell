...
```
Invoke-DataverseGetFileSasUrl -Connection <ServiceClient> -Target <PSObject> [-FileAttributeName <String>]
 [-DataSource <String>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### -Target
Gets or sets a reference to the table row that contains the data. Accepts PSObject with Id and TableName/EntityName/LogicalName properties, or a string containing the entity name for lookup by name.
