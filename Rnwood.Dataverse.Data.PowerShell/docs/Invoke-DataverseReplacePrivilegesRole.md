...
```
Invoke-DataverseReplacePrivilegesRole -Connection <ServiceClient> [-RoleId <Guid>]
 [-Privileges <RolePrivilege[]>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
