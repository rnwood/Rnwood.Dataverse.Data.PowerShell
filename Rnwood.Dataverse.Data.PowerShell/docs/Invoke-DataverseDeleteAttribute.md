...
# Invoke-DataverseDeleteAttribute
...
```
Invoke-DataverseDeleteAttribute -Connection <ServiceClient> [-LogicalName <String>]
...
### Example 1
```powershell
PS C:\> Invoke-DataverseDeleteAttribute -Connection <ServiceClient> -LogicalName <String> -EntityLogicalName <String>
```
